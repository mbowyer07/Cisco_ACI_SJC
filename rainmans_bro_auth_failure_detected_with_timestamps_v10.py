...
def main():
    ...
    for row in switch_input_file:
      ...
      try:
        ...
        print >> f, (time_of_err + ', ' + ipaddr + ', ' + "Authentication Failed")

        print "Bummer! Errors were Detected. Examine vtp_auth_errors"

        continue

    print "Awesome! Data Gathered, Bro.  Please check vtp.csv"
